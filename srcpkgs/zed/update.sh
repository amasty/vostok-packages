...
echo "Fetching latest Zed version..."
...
if [ "$CURRENT" = "$LATEST" ]; then
    echo "zed: $CURRENT — already up to date"
    exit 0
fi

echo "zed: $CURRENT → $LATEST"

ARCHIVE_URL="https://github.com/zed-industries/zed/releases/download/v${LATEST}/zed-linux-x86_64.tar.gz"
